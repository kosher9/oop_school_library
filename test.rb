...
def test
  ...
  app.create_teacher(specialization: 'Math', age: 20, name: 'Life', parent_permission: false)
  app.create_teacher(specialization: 'Info', age: 27, name: 'Lijbkfe', parent_permission: false)
